        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="submit" name="submit" value="Update" style="background-color: green; color: white; border: none; padding: 5px 10px;">
                    <a href="index.php" style="background-color: red; color: white; border: none; padding: 5px 10px; text-decoration: none;">Batal</a>
                </td>
            </tr>
        </table>
    </form>
