...
<head>
    ...
    <style>
        ...
        @media print {
            .navbar, .form-filter, .btn, .header-bar, hr {
                display: none; 
            }
            .card {
                border: none; 
...
<body>
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <a href="index.php" class="btn btn-kembali mb-3">&lt; Kembali</a>
                <form action="report_transaksi.php" method="GET" class="form-filter">
    ...
    <script>
        <?php if (isset($_GET['tampilkan']) AND !empty($data_laporan)): ?>
