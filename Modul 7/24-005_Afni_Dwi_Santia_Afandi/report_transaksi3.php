...
<div style="width: 90%; margin: 30px auto;">
    ...
    <div style="background: white; border: 1px solid #ccc; border-radius: 5px;">
        ...
        <div style="background: #174372; padding: 15px; color: white; font-weight: bold;">
        ...
        <div style="padding: 20px;">
            ...
            <!-- Tombol Print dan Excel -->
            <a href="cetak_laporan.php?start=<?= $start ?>&end=<?= $end ?>"
                   style="background:#ffc107; padding:8px 15px; border-radius:5px; text-decoration:none;">
                   🖨 Cetak
                </a>
