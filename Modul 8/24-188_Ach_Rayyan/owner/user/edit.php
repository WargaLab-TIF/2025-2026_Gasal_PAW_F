<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE users SET username = '$username', password = '$password', nama = '$nama', alamat = '$alamat', hp = '$hp', level = '$level' WHERE id_user = $id_user";
    ...
    <div class="container">
        <form action="" method="POST">
            ...
            <select name="level" id="level">
                ...
                <option value="1" <?= $result['level'] == 1 ? 'selected' : '' ?>>Level 1</option>
                <option value="2" <?= $result['level'] == 2 ? 'selected' : '' ?>>Level 2</option>
            </select><br><br>
