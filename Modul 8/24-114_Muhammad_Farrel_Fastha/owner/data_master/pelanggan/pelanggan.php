...
$stmt = mysqli_prepare($conn, "SELECT id, nama, jenis_kelamin, telp, alamat FROM pelanggan");
            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item active" href="/praktikum 8/24-114_Muhammad_Farrel_Fastha/owner/data_master/pelanggan/pelanggan.php">Data Pelanggan</a></li>
        ...
        <div class="card-body">
            ...
            <div class="card shadow">
                <div class="card-header bg-primary text-white d-flex justify-content-between">
                    ...
                    <a href="./tambah.php" class="btn btn-warning btn-sm">+ Tambah Pelanggan</a>
                </div>
