...
<div style="width: 90%; margin: auto; background: powderblue; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px blue;">
        ...
        <tr>
            ...
            <td>
                <a href="hapus_barang.php?id=<?php echo $row['id']; ?>"
                   ...
                   style="color: white; background-color: steelblue; padding: 5px 10px; border-radius: 5px; text-decoration: none;">
                   Delete
                </a>
            </td>
        </tr>
