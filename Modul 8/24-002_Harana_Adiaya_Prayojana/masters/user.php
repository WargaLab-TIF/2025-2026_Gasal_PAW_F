...
<main class="layout">
    ...
    <br>
    <form action="./add/addUser.php" ><button class="adding">Tambah User</button></form>
        ...
        <tr>
            ...
            <td>
                <div style="display:flex; align-items:center; margin-bottom:10px; justify-content: space-between;">
                    <button class="detail" onclick="location.href='./edit/edser.php?id_user=<?=$row['id_user']?>'">Edit</button>
