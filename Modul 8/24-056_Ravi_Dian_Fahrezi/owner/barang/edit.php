...
<body>
    <div class="container">
        <form action="" method="POST">
            ...
            <input type="text" name="kode_barang" id="kode_barang" value="<?= $result['kode_barang'] ?>"><br><br>

            <label for="nama_barang">Nama Barang: </label><br>
            <input type="text" name="nama_barang" id="nama_barang" value="<?= $result['nama_barang'] ?>">

            <label for="harga">Harga: </label><br>
            <input type="number" name="harga" id="harga" value="<?= $result['harga'] ?>"><br><br>

            <label for="stok">Stok: </label><br>
            <input type="number" name="stok" id="stok" value="<?= $result['stok'] ?>"><br><br>
