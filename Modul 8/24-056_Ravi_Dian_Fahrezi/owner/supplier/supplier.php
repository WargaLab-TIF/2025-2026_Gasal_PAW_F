...
<head>
    ...
    <link rel="stylesheet" href="../../css/supplier/indexStyle.css">
    <title>Dashboard Data Supplier</title>
</head>
<body>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn-hapus" onclick="if (confirm('Yakin ingin menghapus supplier <?= $row['nama'] ?>?')) { window.location.href='delete.php?id=<?= $row['id'] ?>'; }">Hapus</button>
                    </td>
                </tr>
            <?php endforeach;?>
        </tbody>
