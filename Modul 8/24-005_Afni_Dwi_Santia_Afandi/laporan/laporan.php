...
$hasilJumlah = mysqli_fetch_assoc(mysqli_query($koneksi, $sqlJumlahTransaksi));
...
<div style="width: 90%; margin: 30px auto;">
    ...
    <div style="background: white; border: 1px solid #ccc; border-radius: 5px;">
        ...
        <div style="background: #e8dff5; padding: 15px; color: purple; font-weight: bold;">
        ...
        <div style="padding: 20px;">
            ...
            <a href="../index.php"
               style="background: #FEC8D8; color: purple; padding: 8px 15px;
                      border-radius: 5px; text-decoration: none;">
               Kembali
            </a>
            
            <a href="cetak_laporan.php?start=<?= $start ?>&end=<?= $end ?>"
                   style="background:#BBCFFF; padding:8px 15px; border-radius:5px; text-decoration:none;">
                   🖨 Cetak
                </a>

                <a href="excel.php?start=<?= $start ?>&end=<?= $end ?>"
                   style="background: #28a745; padding: 8px 15px; color: white; 
                          border-radius: 5px; text-decoration: none;">
                    📊 Excel
                </a>
            ...
            <form method="GET" style="margin-top: 20px;">
                ...
                <button type="submit"
                        style="background: #C8CEEE; color: purple; padding: 9px 18px;
            ...
            <table border="1" cellpadding="8" cellspacing="0"
                ...
                <?php if (count($rows) > 0) { $no = 1; ?>
                    ...
                    <?php } ?>
                <?php } else { ?>
                    <tr><td colspan="3" style="padding: 10px; color: gray;">Tidak ada data.</td></tr>
                <?php } ?>
