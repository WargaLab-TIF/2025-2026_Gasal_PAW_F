...
// --- Update otomatis kolom total di tabel transaksi ---
...
while ($d = mysqli_fetch_assoc($detail)) {
    ...
    // Tambahkan harga ke total transaksi itu
...
<div style="text-align: center;">
    <a href="tambah_transaksi.php" 
       style="background-color: #BBCFFF; color: purple; padding: 10px 20px; border-radius: 5px; text-decoration: none; margin-right: 10px;">
       Tambah Transaksi
    </a>

    <a href="tambah_detail_transaksi.php" 
       style="background-color: #FEC8D8; color: purple; padding: 10px 20px; border-radius: 5px; text-decoration: none; margin-right: 10px;">
       Tambah Transaksi Detail
    </a>

    <a href="../index.php" 
       style="background-color: #F8F1D5; color: purple; padding: 10px 20px; border-radius: 5px; text-decoration: none;">
       Kembali
    </a>
</div>
